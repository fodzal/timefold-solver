 ...
 * which is the point of {@link GraphStructure#MULTI_ENTITY_SINGLE_DIRECTIONAL_PARENT}.
 */
class MultiEntitySingleDirectionalParentVariableReferenceGraphTest {
    ...
    void onlyReachableEntitiesAreRecomputed() {
        ...
        assertThat(graphStructureAndDirection.structure())
                .isEqualTo(GraphStructure.MULTI_ENTITY_SINGLE_DIRECTIONAL_PARENT);
        ...
        // The entities are passed in an arbitrary order; the graph derives its own topological order.
        var graph = DefaultShadowVariableSessionFactory.buildMultiEntitySingleDirectionalParentGraph(
        ...
        // Every entity is computed exactly once on construction.
