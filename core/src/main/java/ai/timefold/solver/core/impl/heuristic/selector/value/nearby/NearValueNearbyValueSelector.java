...
public final class NearValueNearbyValueSelector<Solution_>
        extends AbstractNearbyValueSelector<Solution_, IterableValueSelector<Solution_>, MimicReplayingValueSelector<Solution_>>
        implements IterableValueSelector<Solution_> {

    public NearValueNearbyValueSelector(IterableValueSelector<Solution_> childValueSelector,
    ...
    protected AbstractNearbyDistanceMatrixDemand<?, ?, ?, ?> createDemand() {
        return new ListValueNearbyDistanceMatrixDemand<>(nearbyDistanceMeter, nearbyRandom, childSelector, replayingSelector,
    ...
    private int computeDestinationSize(Object origin) {
        ...
        if (childSize > Integer.MAX_VALUE) {
            throw new IllegalStateException("The childValueSelector (" + childSelector
                    + ") has a valueSize (" + childSize + ") which is higher than Integer.MAX_VALUE.");
        }
